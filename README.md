...
| Evaluation | [An LLM judge built to be checked against human labels](https://github.com/ellehelvig/hr-ai-transformation-playbook/tree/main/09-evals) (no labeled run yet) and [Resolve's held-out results](https://github.com/ellehelvig/peopleops-resolution-agent/blob/main/docs/evaluation-methodology.md#held-out-cases) |
