...
[Explore my portfolio](https://ellehelvig.github.io/) · [Connect on LinkedIn](https://www.linkedin.com/in/ellehelvig/)

## Start here

| Leadership capability | Evidence |
| --- | --- |
| Set AI strategy | [HR AI Transformation Playbook](https://github.com/ellehelvig/hr-ai-transformation-playbook): use-case prioritization, roadmap, operating guidance, and ROI |
| Govern implementation | [Governance and evaluation suite](https://github.com/ellehelvig/hr-ai-transformation-playbook/tree/main/03-governance): source-backed claims, risk assessment, evaluations, and human-review controls |
| Make the work tangible | [Resolve: PeopleOps Resolution Agent](https://github.com/ellehelvig/peopleops-resolution-agent): synthetic requests, policy citations, approval queue, audit events, and production gaps |
...
- [Governance templates and a claims registry](https://github.com/ellehelvig/hr-ai-transformation-playbook/tree/main/03-governance) with primary-source links and scheduled checks.
...
**My role:** Defined the HR operating problems, designed the toolkit and governance approach, built the implementation with AI-assisted development, tested the work against documented scenarios, and identified where Legal, Privacy, Security, and engineering review remain necessary.

Automated checks improve traceability. They do not replace legal review or establish that every claim has been independently verified.
...
**My role:** Defined the use case and operating requirements, designed the workflow and human-review model, built the prototype with AI-assisted development, validated the included scenarios, and documented what a production implementation would still require.

The demo uses synthetic data and self-reported reviewer identities. Its results describe the included deterministic scenarios, not production authorization or general LLM safety.

## What this portfolio demonstrates

- Translating ambiguous HR problems into testable workflows
- Separating prototype evidence from production claims
- Designing human accountability into consequential decisions
- Evaluating failure cases, not only happy paths
- Connecting governance requirements to implementation
- Planning for adoption, measurement, and operating ownership
